              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700 mt-1">
                    This admin panel is protected. Only authorized personnel can
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        <div className="container mx-auto px-6 py-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-gray-800">
                        Welcome to StyleStore Admin
                      </h2>
                      <p className="text-gray-600">
                        Manage your store, products, and analytics from here
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          {activeTab === 'analytics' && (
            <AnalyticsDashboard analytics={analytics} demoMode={false} />
          )}
          ...
          {activeTab === 'marketing' && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Coming soon - Campaign management and promotional tools
              </p>
            </div>
          )}
        </div>
