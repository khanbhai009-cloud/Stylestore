                ...
                <div className="text-center space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                      ...
                      arrivals, exclusive deals, and style tips. Plus, get an
                      instant 20% discount on your first purchase!
                    </p>
                  </div>
                ...
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Thank you for subscribing! Check your email for your 20%
                      discount code.
                    </p>
                  </div>
                  <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    <p className="text-sm text-green-800 dark:text-green-200">
                      🎉 Your discount code is on its way! Start shopping and
