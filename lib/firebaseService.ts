...
export const productService = {
  ...
  async addProduct(product: Omit<Product, "id">): Promise<string | null> {
    try {
      ...
      if (isFirebaseAvailable()) {
        try {
          ...
          if (db) {
            ...
            console.log("鉁� Product added to both Firebase and local store")
            return docRef.id
          }
        } catch (error) {
      ...
      console.log("鉁� Product added to local store (demo mode)")
      return localId
    } catch (error) {
      console.error("鉂� Error adding product:", error)
  ...
  async updateProduct(id: string, updates: Partial<Product>): Promise<boolean> {
    try {
      ...
      if (isFirebaseAvailable()) {
        try {
          ...
          if (db) {
            ...
            console.log("鉁� Product updated in both Firebase and local store")
            return true
          }
        } catch (error) {
      ...
      console.log("鉁� Product updated in local store (demo mode)")
      return success
    } catch (error) {
      console.error("鉂� Error updating product:", error)
      return false
    }
  },
  ...
  async deleteProduct(id: string): Promise<boolean> {
    try {
      ...
      if (isFirebaseAvailable()) {
        try {
          ...
          if (db) {
            ...
            console.log("鉁� Product deleted from both Firebase and local store")
            return true
          }
        } catch (error) {
      ...
      console.log("鉁� Product deleted from local store (demo mode)")
      return success
    } catch (error) {
      console.error("鉂� Error deleting product:", error)
      return false
    }
  },
    ...
    if (isFirebaseAvailable()) {
      try {
        ...
        if (db) {
          ...
          console.log("鉁� Click count updated in Firebase")
        }
      } catch (error) {
