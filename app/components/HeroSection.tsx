          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-gray-800 dark:text-white">StyleStore</span>
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl">
                Discover amazing fashion finds at unbeatable prices. From trendy tops to stylish accessories, find your
                perfect look and embrace the blessing of great style.
              </p>
            </div>
          ...
          <div className="relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 animate-slide-up">
                    <p className="text-gray-600 dark:text-gray-400">
                      ✨ <span className="font-medium">Shop with happiness & joy</span>
                    </p>
                    <p className="text-gray-600 dark:text-gray-400">
                      🛍️ <span className="font-medium">Every purchase is a blessing</span>
                    </p>
                    <p className="text-gray-600 dark:text-gray-400">
                      💖 <span className="font-medium">Best deals just for you</span>
                    </p>
                  </div>
                </div>
            ...
            <div className="absolute -top-4 -left-4 bg-white dark:bg-gray-800 rounded-lg p-3 shadow-lg border border-orange-200 dark:border-orange-700 animate-float">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-800 dark:text-white">Premium Quality</span>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -right-4 bg-white dark:bg-gray-800 rounded-lg p-3 shadow-lg border border-orange-200 dark:border-orange-700 animate-float-delayed">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-800 dark:text-white">Made with Love</span>
              </div>
            </div>
