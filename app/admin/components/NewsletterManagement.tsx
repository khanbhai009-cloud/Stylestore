...
import { Mail, Search, Download, Trash2, UserX, Users, TrendingUp, Calendar, Filter, Copy } from "lucide-react"
import { newsletterService, type NewsletterSubscriber } from "@/lib/newsletterService"
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <Button onClick={copyEmailList} variant="outline" size="sm" className="bg-transparent">
                <Copy className="h-4 w-4 mr-2" />
                Copy Emails
              </Button>
              <Button onClick={handleExportCSV} variant="outline" size="sm" className="bg-transparent">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-orange-200">
                  <th className="text-left p-3 font-medium text-gray-900">Email Address</th>
                  <th className="text-left p-3 font-medium text-gray-900">Status</th>
                  <th className="text-left p-3 font-medium text-gray-900">Subscribed Date</th>
              ...
              <tbody>
                {filteredSubscribers.map((subscriber) => (
                  <tr key={subscriber.id} className="border-b border-gray-100 hover:bg-orange-50/50 transition-colors">
                    <td className="p-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">ID: {subscriber.id.slice(-8)}</p>
                        </div>
                      </div>
                    </td>
                    <td className="p-3">
                    ...
                    <td className="p-3">
                      <div>
                        <p className="text-sm font-medium text-gray-900">{formatDate(subscriber.subscribed_at)}</p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
              <h4 className="font-semibold text-blue-900 mb-2">Email Campaign</h4>
              <p className="text-sm text-blue-700 mb-3">Send newsletter to all active subscribers</p>
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
              ...
              <p className="text-sm text-green-700 mb-3">Import subscribers from CSV file</p>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
              ...
              <p className="text-sm text-purple-700 mb-3">View detailed subscriber analytics</p>
