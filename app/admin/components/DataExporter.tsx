...
export default function DataExporter({ products, analytics }: DataExporterProps) {
  ...
  const exportProductsCSV = () => {
    const headers = ["name", "description", "price", "original_price", "category", "tags", "clicks", "is_active"]
  ...
  const exportAnalyticsCSV = () => {
    const analyticsData = [
      ...
      { metric: "total_products", value: analytics.totalProducts },
      {
        ...
        value: analytics.totalProducts > 0 ? Math.round(analytics.totalClicks / analytics.totalProducts) : 0,
      },
    ]
