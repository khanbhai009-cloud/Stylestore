...
import { ShoppingBag, Search, Eye, Package, Truck, CheckCircle, Clock, DollarSign } from "lucide-react"
                  ...
                  <tr key={order.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-3">
                      <Button
                        ...
                        variant="outline"
                        onClick={() => {
                          alert("Order details view is not available. Configure Supabase to enable this feature.")
                        }}
                      >
