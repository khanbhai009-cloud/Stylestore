...
import { Users, Search, Plus, Edit, Trash2, Mail, Calendar, Shield } from "lucide-react"
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {users.filter((u) => new Date(u.joinedDate) > new Date(Date.now() - 30 * 24 * 60 * 60 * 1000)).length}
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left p-3 font-medium text-gray-900">Orders</th>
